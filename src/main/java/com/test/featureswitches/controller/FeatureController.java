...
public class FeatureController {
	...
	/**
	 * Get feature access data based on {@code featureName} and {@code email}
	 * parameters.
	 * 
	 * @param featureName feature name to query
	 * @param email       email of user to query
	 * @return JSON response with {@code canAccess} key taken from {@code enable}
	 *         value.
	 */
	@GetMapping
	...
	/**
	 * 
	 * @param newFeature the new feature to be added, or the existing feature to be
	 *                   updated.
	 * @return response with status 200 for successful database operation; status
	 *         304 for any failure.
	 */
	@PostMapping
